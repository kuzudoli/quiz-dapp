...
const Join = ({question, cost, prize, join, winnerList, loading}) => {
  const web3 = new Web3();
  return (
        ...
        <div className='messageContainer'>
          {question.qDesc === "" ? (
            ...
            <>
              ...
              <a href="/#join" className="connect-btn" id='joinBtn' 
                  style={{
                    pointerEvents:question.qDesc === "" || loading ? "none" : "all", 
                    opacity:question.qDesc === "" || loading ? "0.5" : "1"}} onClick={join}>Join Now!</a>
            </>
          )}
        </div>
    </div>
